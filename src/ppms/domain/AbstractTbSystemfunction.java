...
/**
 * AbstractTbSystemfunction entity provides the base persistence definition of the TbSystemfunction entity. @author MyEclipse Persistence Tools
 */
...
public abstract class AbstractTbSystemfunction  implements java.io.Serializable {
    ...
    /** full constructor */
    public AbstractTbSystemfunction(String functionid, String functionname, Boolean functiontype, String functionurl, String parentfunctionid, Boolean scope, String seq, Date createdtime, Set tbRolefunctions) {
        this.functionid = functionid;
