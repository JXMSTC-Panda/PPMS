...
/**
 * AbstractTbPointdetail entity provides the base persistence definition of the TbPointdetail entity. @author MyEclipse Persistence Tools
 */
...
public abstract class AbstractTbPointdetail  implements java.io.Serializable {
    ...
    /** full constructor */
    public AbstractTbPointdetail(String pointid, TbPoint tbPoint, String operationname, Double operationscore, String seq, String createdby, Date createdtime, String modifiedby, Date modifiedtime) {
        this.pointid = pointid;
        this.tbPoint = tbPoint;
