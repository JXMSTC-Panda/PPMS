...
/**
 * AbstractTbChangejobhistory entity provides the base persistence definition of the TbChangejobhistory entity. @author MyEclipse Persistence Tools
 */

public abstract class AbstractTbChangejobhistory  implements java.io.Serializable {
    ...
    /** full constructor */
    public AbstractTbChangejobhistory(String jobhistoryid, TbEmployee tbEmployee, TbJob tbJobByInjobid, TbJob tbJobByOutjobid, Date changedate, String createdby, Date createdtime, String modifiedby, Date modifiedtime) {
        this.jobhistoryid = jobhistoryid;
