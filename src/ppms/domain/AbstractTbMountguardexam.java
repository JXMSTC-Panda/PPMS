...
/**
 * AbstractTbMountguardexam entity provides the base persistence definition of the TbMountguardexam entity. @author MyEclipse Persistence Tools
 */
...
public abstract class AbstractTbMountguardexam  implements java.io.Serializable {
    ...
    /** full constructor */
    public AbstractTbMountguardexam(String examid, OrganizationNj organizationNj, TbEmployee tbEmployee, String examtype, Date examdate, Double examexpire, Double examscore, BigDecimal holdfailurecount, Date lastdeletedtime, String createdby, Date createdtime, String modifiedby, Date modifiedtime) {
        this.examid = examid;
