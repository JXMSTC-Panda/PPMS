...
/**
 * AbstractTbPerformance entity provides the base persistence definition of the TbPerformance entity. @author MyEclipse Persistence Tools
 */
...
public abstract class AbstractTbPerformance  implements java.io.Serializable {
    ...
    /** full constructor */
    public AbstractTbPerformance(String performanceid, OrganizationNj organizationNj, TbEmployee tbEmployee, Boolean performancetype, Date performancedate, Double performancescore, String remark, String gradestandardorgfilename, String gradestandardfilename, String createdby, Date createdtime, String modifiedby, Date modifiedtime) {
        this.performanceid = performanceid;
