...
/**
 * AbstractTbMonitorcheck entity provides the base persistence definition of the TbMonitorcheck entity. @author MyEclipse Persistence Tools
 */
...
public abstract class AbstractTbMonitorcheck  implements java.io.Serializable {
    ...
    /** full constructor */
    public AbstractTbMonitorcheck(String monitorcheckid, OrganizationNj organizationNj, Date checkdate, String checktype, String detail, String createdby, Date createdtime, String modifiedby, Date modifiedtime) {
        this.monitorcheckid = monitorcheckid;
