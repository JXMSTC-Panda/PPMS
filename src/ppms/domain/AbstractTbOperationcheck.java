...
/**
 * AbstractTbOperationcheck entity provides the base persistence definition of the TbOperationcheck entity. @author MyEclipse Persistence Tools
 */
...
public abstract class AbstractTbOperationcheck  implements java.io.Serializable {
    ...
    /** full constructor */
    public AbstractTbOperationcheck(String operationcheckid, OrganizationNj organizationNj, TbEmployee tbEmployee, Date operationdate, String customermobilenumber, String operationtype, String punishresult, String createdby, Date createdtime, String modifiedby, Date modifiedtime) {
        this.operationcheckid = operationcheckid;
