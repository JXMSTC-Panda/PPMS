...
/**
 * AbstractTbJob entity provides the base persistence definition of the TbJob entity. @author MyEclipse Persistence Tools
 */
...
public abstract class AbstractTbJob  implements java.io.Serializable {
    ...
    /** full constructor */
    public AbstractTbJob(String jobid, TbStage tbStage, TbPost tbPost, String jobname, String jobcomment, Boolean jobtype, String seq, String createdby, Date createdtime, String modifiedby, Date modifiedtime, Date deletedtime, Set tbEmployees, Set tbChangejobhistoriesForInjobid, Set tbPoints, Set tbChangejobhistoriesForOutjobid) {
        this.jobid = jobid;
    ...
    public void setTbChangejobhistoriesForInjobid(Set tbChangejobhistoriesForInjobid) {
        this.tbChangejobhistoriesForInjobid = tbChangejobhistoriesForInjobid;
    }
    ...
    public void setTbChangejobhistoriesForOutjobid(Set tbChangejobhistoriesForOutjobid) {
        this.tbChangejobhistoriesForOutjobid = tbChangejobhistoriesForOutjobid;
    }
