...
/**
 * AbstractTbSystemsettings entity provides the base persistence definition of the TbSystemsettings entity. @author MyEclipse Persistence Tools
 */
...
public abstract class AbstractTbSystemsettings  implements java.io.Serializable {
    ...
    /** full constructor */
    public AbstractTbSystemsettings(String settingsid, String mastertype1, String key1, String mastertype2, String key2, String value, Boolean valuetype, String createdby, Date createdtime, String modifiedby, Date modifiedtime) {
        this.settingsid = settingsid;
