...
/**
 * AbstractTbStandardcheck entity provides the base persistence definition of the TbStandardcheck entity. @author MyEclipse Persistence Tools
 */
...
public abstract class AbstractTbStandardcheck  implements java.io.Serializable {
    ...
    /** full constructor */
    public AbstractTbStandardcheck(String standardcheckid, OrganizationNj organizationNj, Date checkdate, Double checkscore, String createdby, Date createdtime, String modifiedby, Date modifiedtime) {
        this.standardcheckid = standardcheckid;
