...
/**
 * AbstractTbChangeorghistory entity provides the base persistence definition of the TbChangeorghistory entity. @author MyEclipse Persistence Tools
 */

public abstract class AbstractTbChangeorghistory  implements java.io.Serializable {
    ...
    /** full constructor */
    public AbstractTbChangeorghistory(String orghistoryid, TbEmployee tbEmployee, OrganizationNj organizationNjByOutorgid, OrganizationNj organizationNjByInorgid, Date changedate, String createdby, Date createdtime, String modifiedby, Date modifiedtime) {
        this.orghistoryid = orghistoryid;
    ...
    public void setOrganizationNjByOutorgid(OrganizationNj organizationNjByOutorgid) {
        this.organizationNjByOutorgid = organizationNjByOutorgid;
    }
    ...
    public void setOrganizationNjByInorgid(OrganizationNj organizationNjByInorgid) {
        this.organizationNjByInorgid = organizationNjByInorgid;
    }
