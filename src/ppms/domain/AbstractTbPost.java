...
/**
 * AbstractTbPost entity provides the base persistence definition of the TbPost entity. @author MyEclipse Persistence Tools
 */
...
public abstract class AbstractTbPost  implements java.io.Serializable {
    ...
    /** full constructor */
    public AbstractTbPost(String postid, String postname, String postcomment, String seq, String createdby, Date createdtime, String modifiedby, Date modifiedtime, Date deletedtime, Set tbEmployees, Set tbJobs) {
        this.postid = postid;
