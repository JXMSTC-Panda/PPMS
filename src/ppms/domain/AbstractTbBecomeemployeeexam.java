...
/**
 * AbstractTbBecomeemployeeexam entity provides the base persistence definition of the TbBecomeemployeeexam entity. @author MyEclipse Persistence Tools
 */

public abstract class AbstractTbBecomeemployeeexam  implements java.io.Serializable {
    ...
    /** full constructor */
    public AbstractTbBecomeemployeeexam(String examid, OrganizationNj organizationNj, TbEmployee tbEmployee, Date examdate, Double examscore, Short chineseprintcount, Short numberprintcount, String remark, String createdby, Date createdtime, String modifiedby, Date modifiedtime) {
        this.examid = examid;
