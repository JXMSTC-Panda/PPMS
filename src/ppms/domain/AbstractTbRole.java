...
/**
 * AbstractTbRole entity provides the base persistence definition of the TbRole entity. @author MyEclipse Persistence Tools
 */
...
public abstract class AbstractTbRole  implements java.io.Serializable {
    ...
    /** full constructor */
    public AbstractTbRole(String roleid, String rolename, Boolean administratorflag, String seq, String createdby, Date createdtime, String modifiedby, Date modifiedtime, Set tbEmployees, Set tbRolefunctions) {
        this.roleid = roleid;
