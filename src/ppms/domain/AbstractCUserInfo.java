...
/**
 * AbstractCUserInfo entity provides the base persistence definition of the CUserInfo entity. @author MyEclipse Persistence Tools
 */
...
public abstract class AbstractCUserInfo  implements java.io.Serializable {
    ...
    /** full constructor */
    public AbstractCUserInfo(BigDecimal operid, OrganizationNj organizationNj, String opername, String operpass, String roleid, BigDecimal departid, BigDecimal centerid, String zwid, BigDecimal usercountry, BigDecimal isvalid, BigDecimal shortnum, BigDecimal mobilenum, BigDecimal operatingid, Date operatingdate) {
        this.operid = operid;
