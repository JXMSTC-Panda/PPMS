...
/**
 * AbstractTbRolefunction entity provides the base persistence definition of the TbRolefunction entity. @author MyEclipse Persistence Tools
 */
...
public abstract class AbstractTbRolefunction  implements java.io.Serializable {
    ...
    /** full constructor */
    public AbstractTbRolefunction(TbRolefunctionId id, String employeesearchscope, String orgsearchscope) {
        this.id = id;
