...
<script language="javascript" defer=true>
	function doConfirm()
	{
		if(confirm("确定录入的信息正确吗？"))
		{
			location.href="employeePraiseCriticismDetailList.html";
		}
		return;
	}
	...
	{
		window.open('../../selectSingleEmployee.html', 'newwindow');
	}
	...
	subcat = new Array();
	subcat[0] = new Array("中心通报","01","001");
	subcat[1] = new Array("公司发文","01","002");
	subcat[2] = new Array("区域通报","01","003");
	subcat[3] = new Array("区域通报","01","004");
	subcat[4] = new Array("中心通报","02","005");
	subcat[5] = new Array("公司发文","02","006");
	subcat[6] = new Array("区域表彰","02","007");
	subcat[7] = new Array("中心通报","06","008");
	subcat[8] = new Array("公司发文","06","009");
	subcat[9] = new Array("区域通报","06","010");
	subcat[10] = new Array("中心通报","05","011");
	subcat[11] = new Array("公司发文","05","012");
	subcat[12] = new Array("区域表彰","05","013");
	subcat[13] = new Array("月度考试成绩","03","014");
	subcat[14] = new Array("新员工考核成绩","04","015");

	onecount=15;

	function changelocation(locationid)
	{
		document.updatesingleform.praiseCriticismLevel.length = 0;

		var locationid=locationid;
		var i;
		//document.updatesingleform.praiseCriticismLevel.options[0] = new Option('','0');
		for (i=0;i <onecount; i++)
		{
			if (subcat[i][1] == locationid)
			{
				document.updatesingleform.praiseCriticismLevel.options[document.updatesingleform.praiseCriticismLevel.length]
									...
									<div class="col-xs-12">
										...
										<form class="form-horizontal" name="form1" role="form"
											...
											<!-- #section:elements.form -->
												...
												<div class="form-group">
													...
													<div class="col-sm-9">
														<input readonly="" type="text" class="col-xs-10 col-sm-5"
															...
															name="tbEmployeepraisecriticism.organizationNj.orgName" />
												...
												var="employeeInfo">${employeeInfo.organizationNj.orgid}</c:forEach>"
															name="tbEmployeepraisecriticism.organizationNj.orgid" />
														<span class="help-inline col-xs-12 col-sm-7"> </span>
													</div>
												</div>
												<div class="form-group">
													...
													<div class="col-sm-9">
														<input readonly="" type="text" class="col-xs-10 col-sm-5"
															id="form-input-readonly" value="<c:forEach items="${requestScope.employeeInfos}"
												var="employeeInfo">${employeeInfo.organizationNj.org_Name}</c:forEach>"
															name="tbEmployeepraisecriticism.organizationNj.orgName" />
														<span class="help-inline col-xs-12 col-sm-7"> </span>
													</div>
												</div>
												...
												var="employeeInfo">${employeeInfo.employeename}</c:forEach>"
															name="tbEmployeepraisecriticism.tbEmployee.employeename" />
												...
												<div class="form-group">
													...
													<div class="col-sm-9">
														<input readonly="" type="text" class="col-xs-10 col-sm-5"
															id="form-input-readonly" value="<c:forEach items="${requestScope.employeeInfos}"
												var="employeeInfo">${employeeInfo.idnumber}</c:forEach>"
															name="tbEmployeepraisecriticism.tbEmployee.idnumber" />
											...
											<div class="form-group">
												<label class="col-sm-3 control-label no-padding-right"
													for="form-input-readonly"> 奖惩原因： </label>
												...
												<div class="col-sm-9">
													<div class="input-group col-xs-10 col-sm-5">
														<input class="form-control date-picker "
															...
															name="tbEmployeepraisecriticism.praisecriticismdate" /> <span
