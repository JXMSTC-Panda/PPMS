			...
			<div class="main-content-inner">
				<div class="breadcrumbs" id="breadcrumbs">
					...
					<ul class="breadcrumb">
						...
						<li class="active">营业厅奖惩信息单条修改</li>
					</ul>
									...
									<div class="col-xs-12">
										...
										<form class="form-horizontal" role="form" method="post"
											...
											<div class="form-group">
												...
												<div class="col-sm-9">
													<input readonly="" type="text" class="col-xs-10 col-sm-5"
														...
														value="<c:forEach items="${requestScope.organizationNjInfor}" 
														var="organizationNj">${organizationNj.orgid}</c:forEach>"
														name="tbOrgpraisecriticism.organizationNj.orgid" /> <span
														class="help-inline col-xs-12 col-sm-7"> </span>
												</div>
											</div>
											<div class="form-group">
												...
												<div class="col-sm-9">
													<input readonly="" type="text" class="col-xs-10 col-sm-5"
														id="form-input-readonly"
														value="<c:forEach items="${requestScope.organizationNjInfor}" 
														var="organizationNj">${organizationNj.org_Name}</c:forEach>"
											...
											<div class="form-group">
												...
												<div class="col-sm-9">
													<select class="col-xs-10 col-sm-5" id="form-field-select-1"
														name="tbOrgpraisecriticism.praisecriticismlevel">
