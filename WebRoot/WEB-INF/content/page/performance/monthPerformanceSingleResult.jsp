								...
								<tr>
									<td><br />
										<table cellpadding="0" cellspacing="0" width="95%"
											...
											<tr>
												<td class=" titlebold">月度绩效单条录入结果</td>
											</tr>
										</table>
										<table cellpadding="0" cellspacing="0" width="95%"
											align="center">
										...
										<table cellpadding="0" cellspacing="0" width="95%"
											...
											<tr>
												<td align="center"><input type="button"
													...
													onclick="location.href='performance.month.monthPerformanceSingle.do'"
													class="btn_5"> <input type="button"
													name="goSearchButton" value="转至查询"
													onclick="location.href='performance.month.monthPerformanceSearch.do'"
													class="btn_5"></td>
											</tr>
										</table> <br /> <br /></td>
								</tr>
