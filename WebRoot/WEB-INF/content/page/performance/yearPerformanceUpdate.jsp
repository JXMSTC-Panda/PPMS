			...
			<div class="main-content-inner">
								...
								<div class="row">
									<div class="col-xs-12">
													...
													<form class="form-horizontal" role="form" method="post"
														...
														<div class="form-group">
															...
															<div class="col-sm-9">
																<input readonly="" type="text"
																	...
																	value="" name="tbArea.areadesc" /> <span
														...
														<div class="form-group">
															<label class="col-sm-3 control-label no-padding-right"
																for="form-input-readonly"> 成绩： </label>
														...
														<div class="form-group">
															<label
																class="col-sm-3 control-label no-padding-right for="form-field-1">备注:</label>
															<div class="col-sm-9">
				...
				<script type="text/javascript">
					jQuery(function($) {
						...
						$("#slider-eq > span.ui-slider-purple").slider(
								'disable');//disable third item
