															...
															<div class="form-group">
																...
																<div class="col-xs-6">
																	...
																	<select multiple="multiple" size="10" name="duallistbox_demo1[]" id="duallist">
																		<option value="option1">营业厅A</option>
																		<option value="option2">营业厅B</option>
																		<option value="option3">营业厅C</option>
																		<option value="option4">营业厅D</option>
																		<option value="option5">营业厅E</option>
																		<option value="option6">营业厅F</option>							
																	</select>
