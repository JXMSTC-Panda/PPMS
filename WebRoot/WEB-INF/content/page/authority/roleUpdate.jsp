					...
					<div class="row">
						<div class="col-xs-12">
							...
							<div class="page-header">
								<h1>
									权限管理 <small> <i
										class="ace-icon fa fa-angle-double-right"></i> 角色修改 </small>
								</h1>
							</div>
							<div class="col-xs-12">
											<!-- PAGE CONTENT BEGINS -->
											<form class="form-horizontal" role="form">
												...
												<div class="form-group">
													<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 权限角色： </label>
												...
												<div class="form-group">
													<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 系统管理员： </label>
													...
													<div class="col-sm-9">
														<div class="radio">
															...
															<font color="red">[系统管理员可拥有所有操作权限]</font>
														</div>
														
													</div>
												</div>
												<div class="form-group">
													<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 查询范围： </label>

													<div class="col-sm-9">
														<select class="col-xs-10 col-sm-5" id="form-field-select-1">
															<option value=""></option>
															<option value="1">营销中心所有员工</option>
															<option value="2">区域内所有员工</option>
															<option value="3">片区内所有员工</option>
															<option value="4">营业厅内所有员工</option>
															<option value="5">营业厅内除店长外所有员工</option>
