									...
									<div class="row">
										<div class="col-xs-12">
											...
											<form class="form-horizontal" role="form" action="singleUpload">
												...
												<div class="form-group">
													<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 评定时间： </label>
												...
												<div class="form-group">
													<label class="col-sm-3 control-label no-padding-right" for="form-input-readonly"> 部门核定结果： </label>
												...
												<div class="form-group">
													...
													<div class="col-sm-9">
														<input name="form-field-checkbox1" type="checkbox" class="ace" />
														<span class="lbl"> 个人成长档案加分</span>
														<br />
														<input name="form-field-checkbox2" type="checkbox" class="ace" />
														<span class="lbl"> 个人月度绩效</span>
														<br />
														<input name="form-field-checkbox3" type="checkbox" class="ace" />
