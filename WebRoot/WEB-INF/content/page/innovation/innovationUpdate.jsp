						...
						<div class="col-xs-12">
							...
							<div class="page-content">
								...
								<div class="page-header">
									<h1>
										创新管理 <small> <i
											class="ace-icon fa fa-angle-double-right"></i> 创新提案修改 </small>
									</h1>
								</div>
								<!-- /.page-header -->
										...
										<form class="form-horizontal" role="form"
											...
											<div class="form-group">
												...
												<div class="col-sm-9">
													<input readonly="" type="text" class="col-xs-10 col-sm-5"
														...
														value="${requestScope.tbInnovation.organizationNj.areadesc }"
														name="innovation.organizationNj.areadesc" /> <span
											...
											<div class="form-group">
												...
												<div class="col-sm-9">
													<input readonly="" type="text" class="col-xs-10 col-sm-5"
														id="form-input-readonly"
														value="${requestScope.tbInnovation.organizationNj.orgid }"
											...
											<div class="form-group">
												...
												<div class="col-sm-9">
													<input readonly="" type="text" class="col-xs-10 col-sm-5"
														id="form-input-readonly"
														value="${requestScope.tbInnovation.organizationNj.org_Name }"
														class="help-inline col-xs-12 col-sm-7"> </span>
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-sm-9">
													<input readonly="" type="text" class="col-xs-10 col-sm-5"
														id="form-input-readonly"
														value="${requestScope.tbInnovation.tbEmployee.employeecode }"
											...
											<div class="form-group">
												...
												<div class="col-sm-9">
													<input readonly="" type="text" class="col-xs-10 col-sm-5"
														id="form-input-readonly"
														value="${requestScope.tbInnovation.tbEmployee.idnumber }"
											...
											<div class="form-group">
												...
												<div class="col-sm-9">
													<select class="col-xs-10 col-sm-5" id="form-field-select-1"
														...
														<c:if test="${requestScope.tbInnovation.assesslevel==1 }">
															<option value="0001">部门</option>
															<option value="0002">区域</option>
														</c:if>
														<c:if test="${requestScope.tbInnovation.assesslevel==2 }">
															<option value="0002">区域</option>
															<option value="0001">部门</option>
														</c:if>
													</select>
												...
												<div class="col-sm-9">
													<c:if
														...
														<input name="innovation.encouragement" type="checkbox"
															checked="checked" class="ace" value="个人成长档案加分/" />
