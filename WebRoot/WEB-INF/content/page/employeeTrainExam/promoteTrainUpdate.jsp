					...
					<div class="row">
						<div class="col-xs-12">
							...
							<form class="form-horizontal" role="form"
								action="employeeTrainExam.promoteTrain.promoteTrainSearch.update.do"
								method="post">
								<!-- #section:elements.form -->
								<input type="hidden"
									value="${requestScope.promotiontraining.promotiontrainingid }"
									name="tbPromotiontraining.promotiontrainingid">
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input readonly="" type="text" class="col-xs-10 col-sm-5"
											...
											value="${requestScope.promotiontraining.organizationNj.areadesc }"
											name="tbPromotiontraining.organizationNj.areadesc" /> <span
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input readonly="" type="text" class="col-xs-10 col-sm-5"
											id="form-input-readonly"
											value="${requestScope.promotiontraining.organizationNj.orgid}"
											name="tbPromotiontraining.organizationNj.orgid" /> <span
											class="help-inline col-xs-12 col-sm-7"> </span>
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input readonly="" type="text" class="col-xs-10 col-sm-5"
											id="form-input-readonly"
											value="${requestScope.promotiontraining.organizationNj.org_Name}"
											name="tbPromotiontraining.organizationNj.org_Name" /> <span
											class="help-inline col-xs-12 col-sm-7"></span>
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-sm-9">
										<div class="col-xs-10 col-sm-5">
											<select class="chosen-select form-control"
												...
												<option
													value="${requestScope.promotiontraining.tbEmployee.employeeid }">${requestScope.promotiontraining.tbEmployee.employeename}</option>
											</select>
										</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input readonly="" type="text" class="col-xs-10 col-sm-5"
											id="form-input-readonly"
											value="${requestScope.promotiontraining.tbEmployee.employeecode }"
											name="tbPromotiontraining.tbEmployee.employeecode" /> <span
											class="help-inline col-xs-12 col-sm-7"> </span>
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input readonly="" type="text" class="col-xs-10 col-sm-5"
											id="form-input-readonly"
											value="${requestScope.promotiontraining.tbEmployee.idnumber }"
											name="tbPromotiontraining.tbEmployee.idnumber" /> <span
											class="help-inline col-xs-12 col-sm-7"> </span>
									</div>
								</div>
									...
									<div class="col-sm-9">
										<div class="input-group col-xs-10 col-sm-5">
											<input class="form-control date-picker "
												...
												value="${fn:split(requestScope.promotiontraining.promotiontrainingdate,' ')[0]}"
												data-date-format="yyyy-mm-dd"
												name="tbPromotiontraining.promotiontrainingdate" /> <span
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input type="text" id="form-field-1" placeholder="Grade"
											...
											name="tbPromotiontraining.promotionscore"
											value="${requestScope.promotiontraining.promotionscore }" />
