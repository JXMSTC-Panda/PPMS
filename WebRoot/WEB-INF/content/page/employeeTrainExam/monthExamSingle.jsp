...
<script type="text/javascript">
	function getEmployee(obj) {
		top.window.location = "getEmployee.do?backUrl=employeeTrainExam.monthExam.monthExamSingle.do&employeeid="
				+ obj.value;
			...
			<div class="main-content-inner">
				<div class="breadcrumbs" id="breadcrumbs">
					...
					<ul class="breadcrumb">
						...
						<li><a href="#">月度考试管理</a></li>
						<li class="active">月度考试单条录入</li>
					</ul>
				</div>
						...
						<div class="col-xs-12">
							...
							<div class="page-content">
								...
								<div class="page-header">
									<h1>
										月度考试 <small> <i
											class="ace-icon fa fa-angle-double-right"></i> 月度考试单条录入 </small>
									</h1>
								</div>
								<!-- /.page-header -->
								...
								<div class="row">
									<div class="col-xs-12">
										...
										<form class="form-horizontal" role="form"
											action="employeeTrainExam.monthExam.monthExamSingle.MonthExamAdd.do"
											method="post">
