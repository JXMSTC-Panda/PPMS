...
<script type="text/javascript">
	function getEmployee(obj) {
		top.window.location = "getEmployee.do?backUrl=employeeTrainExam.operationTrain.operationTrainSingle.do&employeeid="
				+ obj.value;
								...
								<div class="row">
									<div class="col-xs-12">
										...
										<form class="form-horizontal" role="form"
											action="employeeTrainExam.operationTrain.operationTrainSingle.add.do"
											method="post">
												...
												<div class="col-sm-9">
													<input readonly="" type="text" class="col-xs-10 col-sm-5"
														...
														class="help-inline col-xs-12 col-sm-7"><button
															class="btn btn-info"
															onclick="top.window.location='chooseOrg.do?backUrl=employeeTrainExam.operationTrain.operationTrainSingle.do'"
											...
											<div class="form-group">
												...
												<div class="col-sm-9">
													<input type="text" id="form-field-1" placeholder="Grade"
														class="col-xs-10 col-sm-5"
														name="tbOperationtraining.trainingscore" /> <label
