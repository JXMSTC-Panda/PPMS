					...
					<div class="row">
						<div class="col-xs-12">
							...
							<form class="form-horizontal" role="form"
								action="employeeTrainExam.operationTrain.operationTrainSearch.update.do"
								method="post">
								<!-- #section:elements.form -->
								<input type="hidden"
									value="${requestScope.operationtraining.trainingid }"
									name="tbOperationtraining.trainingid">
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input readonly="" type="text" class="col-xs-10 col-sm-5"
											...
											value="${requestScope.operationtraining.organizationNj.areadesc }"
											name="tbOperationtraining.organizationNj.areadesc" /> <span
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input readonly="" type="text" class="col-xs-10 col-sm-5"
											id="form-input-readonly"
											value="${requestScope.operationtraining.organizationNj.orgid}"
											name="tbOperationtraining.organizationNj.orgid" /> <span
											class="help-inline col-xs-12 col-sm-7"> </span>
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input readonly="" type="text" class="col-xs-10 col-sm-5"
											id="form-input-readonly"
											value="${requestScope.operationtraining.organizationNj.org_Name}"
											name="tbOperationtraining.organizationNj.org_Name" /> <span
											class="help-inline col-xs-12 col-sm-7"></span>
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-sm-9">
										<div class="col-xs-10 col-sm-5">
											<select class="chosen-select form-control"
												...
												<option
													value="${requestScope.operationtraining.tbEmployee.employeeid }">${requestScope.operationtraining.tbEmployee.employeename}</option>
											</select>
										</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input readonly="" type="text" class="col-xs-10 col-sm-5"
											id="form-input-readonly"
											value="${requestScope.operationtraining.tbEmployee.employeecode }"
											name="tbOperationtraining.tbEmployee.employeecode" /> <span
											class="help-inline col-xs-12 col-sm-7"> </span>
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input readonly="" type="text" class="col-xs-10 col-sm-5"
											id="form-input-readonly"
											value="${requestScope.operationtraining.tbEmployee.idnumber }"
											name="tbOperationtraining.tbEmployee.idnumber" /> <span
											class="help-inline col-xs-12 col-sm-7"> </span>
									</div>
								</div>
									...
									<div class="col-sm-9">
										<div class="input-group col-xs-10 col-sm-5">
											<input class="form-control date-picker "
												...
												value="${fn:split(requestScope.operationtraining.trainingdate,' ')[0]}"
												data-date-format="yyyy-mm-dd"
												name="tbOperationtraining.trainingdate" /> <span
								...
								<div class="form-group">
									<label class="col-sm-3 control-label no-padding-right"
										for="form-field-1"> 培训级别： </label>

									<div class="col-sm-9">
										<select class="col-xs-10 col-sm-5" id="form-field-select-1"
											name="tbOperationtraining.traininglevel">
											
												<option value="${requestScope.operationtraining.traininglevel}">${requestScope.operationtraining.traininglevel}</option>
												<option value="0001">区域</option>
												<option value="0002">部门</option>
												<option value="0003">公司</option>
												<option value="0004">省公司</option>
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input type="text" id="form-field-1" placeholder="培训内容"
											class="col-xs-10 col-sm-5" value="${requestScope.operationtraining.trainingcontent }"
											name="tbOperationtraining.trainingcontent" />
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input type="text" id="form-field-1" placeholder="Grade"
											...
											name="tbOperationtraining.trainingscore"
											value="${requestScope.operationtraining.trainingscore }" />
