					...
					<div class="row">
						<div class="col-xs-12">
							...
							<form class="form-horizontal" role="form"
								action="employeeTrainExam.monthExam.monthExamSearch.update.do"
								method="post">
								<!-- #section:elements.form -->
								<input type="hidden" value="${requestScope.monthexam.examid }"
									name="tbMonthexam.examid">
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input readonly="" type="text" class="col-xs-10 col-sm-5"
											...
											value="${requestScope.monthexam.organizationNj.areadesc }"
											name="tbMonthexam.organizationNj.areadesc" /> <span
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input readonly="" type="text" class="col-xs-10 col-sm-5"
											id="form-input-readonly"
											value="${requestScope.monthexam.organizationNj.orgid}"
											name="tbMonthexam.organizationNj.orgid" /> <span
											class="help-inline col-xs-12 col-sm-7"> </span>
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input readonly="" type="text" class="col-xs-10 col-sm-5"
											id="form-input-readonly"
											value="${requestScope.monthexam.organizationNj.org_Name}"
											name="tbMonthexam.organizationNj.org_Name" /> <span
											class="help-inline col-xs-12 col-sm-7"><button
												class="btn btn-info"
												onclick="top.window.location='chooseOrg.do?backUrl=employeeTrainExam.monthExam.monthExamSingle.do'"
									...
									<div class="col-sm-9">
										<div class="col-xs-10 col-sm-5">
											<select class="chosen-select form-control"
												...
												<option
													value="${requestScope.monthexam.tbEmployee.employeeid }">${requestScope.monthexam.tbEmployee.employeename}</option>
											</select>
										</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input readonly="" type="text" class="col-xs-10 col-sm-5"
											id="form-input-readonly"
											value="${requestScope.monthexam.tbEmployee.employeecode }"
											name="tbMonthexam.tbEmployee.employeecode" /> <span
											class="help-inline col-xs-12 col-sm-7"> </span>
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input readonly="" type="text" class="col-xs-10 col-sm-5"
											id="form-input-readonly"
											value="${requestScope.monthexam.tbEmployee.idnumber }"
											name="tbMonthexam.tbEmployee.idnumber" /> <span
											class="help-inline col-xs-12 col-sm-7"> </span>
									</div>
								</div>
									...
									<div class="col-sm-9">
										<div class="input-group col-xs-10 col-sm-5">
											<input class="form-control date-picker "
												...
												value="${fn:split(requestScope.monthexam.examdate,' ')[0]}"
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input type="text" id="form-field-1" placeholder="Grade"
											class="col-xs-10 col-sm-5" name="tbMonthexam.examscore"
											value="${requestScope.monthexam.examscore }" /> <label
