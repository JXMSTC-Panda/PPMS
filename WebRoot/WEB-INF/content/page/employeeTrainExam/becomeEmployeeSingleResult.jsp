		...
		<tr>
			<td >
				...
				<table cellpadding="0" cellspacing="0" width="95%"  align="center" class="tableserch">
					...
					<tr>
						<td align="center" >
							<input type="button" name="goContinueButton" value="继续录入" onclick="location.href='employeeTrainExam.freshEmployeeExam.becomeEmployeeSingle.do'" class="btn_5">
							<input type="button" name="goSearchButton" value="转至查询" onclick="location.href='employeeTrainExam.freshEmployeeExam.becomeEmployeeSearch.do'" class="btn_5">
						</td>
					</tr>
				</table>
				<br />
