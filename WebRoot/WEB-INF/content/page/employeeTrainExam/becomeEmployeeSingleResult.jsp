												...
												<div class="clearfix form-actions">
													<div class="col-md-offset-3 col-md-6">
														<button class="btn btn-info"
															onclick="top.window.location='employeeTrainExam.freshEmployeeExam.becomeEmployeeSingle.do'">
															<i class="ace-icon fa fa-check bigger-110"></i> 继续录入
														</button>

														&nbsp; &nbsp; &nbsp;
														<button class="btn"
															onclick="top.window.location='employeeTrainExam.freshEmployeeExam.becomeEmployeeSearch.do'">
