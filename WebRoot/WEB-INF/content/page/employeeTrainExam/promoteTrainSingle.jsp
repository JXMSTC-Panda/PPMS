...
<script type="text/javascript">
	function getEmployee(obj) {
		top.window.location = "getEmployee.do?backUrl=employeeTrainExam.promoteTrain.promoteTrainSingle.do&employeeid="
				+ obj.value;
						...
						<div class="col-xs-12">
							...
							<div class="page-content">
								...
								<div class="page-header">
									<h1>
										进阶培训 <small> <i
											class="ace-icon fa fa-angle-double-right"></i> 进阶培训单条录入 </small>
									</h1>
								</div>
								<!-- /.page-header -->
								...
								<div class="row">
									<div class="col-xs-12">
										...
										<form class="form-horizontal" role="form"
											action="employeeTrainExam.promoteTrain.promoteTrainSingle.add.do"
											method="post">
												...
												<div class="col-sm-9">
													<input readonly="" type="text" class="col-xs-10 col-sm-5"
														...
														class="help-inline col-xs-12 col-sm-7"><button
															class="btn btn-info"
															onclick="top.window.location='chooseOrg.do?backUrl=employeeTrainExam.promoteTrain.promoteTrainSingle.do'"
											...
											<div class="form-group">
												...
												<div class="col-sm-9">
													<select class="col-xs-10 col-sm-5" id="form-field-select-1"
														...
														<option value=""></option>
														<option value="0001">进阶熟练营业员</option>
														<option value="0002">进阶账务稽核</option>
														<option value="0003">进阶实习值班经理</option>
														<option value="0004">进阶值班经理</option>
														<option value="0005">进阶店长</option>
											...
											<div class="form-group">
												...
												<div class="col-sm-9">
													<input type="text" id="form-field-1" placeholder="Grade"
														...
														name="tbPromotiontraining.promotionscore" /> <label
