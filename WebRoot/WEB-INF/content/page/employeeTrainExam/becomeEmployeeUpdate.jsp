					...
					<div class="row">
						<div class="col-xs-12">
							...
							<form class="form-horizontal" role="form" method="post"
								action="employeeTrainExam.freshEmployeeExam.becomeEmployeeSearch.modify.do">
								<input type="hidden"
									value="${requestScope.tbBecomeemployeeexam.get(0).examid}"
									name="tbBecomeemployeeexam.examid">
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input readonly="" type="text" class="col-xs-10 col-sm-5"
											id="form-input-readonly"
											value="${requestScope.tbBecomeemployeeexam.get(0).organizationNj.orgid }"
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input readonly="" type="text" class="col-xs-10 col-sm-5"
											id="form-input-readonly"
											value="${requestScope.tbBecomeemployeeexam.get(0).organizationNj.org_Name }"
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input readonly="" type="text" class="col-xs-10 col-sm-5"
											id="form-input-readonly" value="${requestScope.tbBecomeemployeeexam.get(0).tbEmployee.employeeid}"
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input type="text" id="form-field-1" placeholder="Grade"
											class="col-xs-10 col-sm-5" value="${requestScope.tbBecomeemployeeexam.get(0).examscore}"
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input type="text" id="form-field-1" placeholder="Grade"
											class="col-xs-10 col-sm-5" value="${requestScope.tbBecomeemployeeexam.get(0).chineseprintcount}"
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input type="text" id="form-field-1" placeholder="Grade"
											class="col-xs-10 col-sm-5" value="${requestScope.tbBecomeemployeeexam.get(0).numberprintcount}"
									...
									<div class="col-sm-9">
										...
										<div class="input-group col-xs-10 col-sm-5">
											<input class="form-control date-picker "
												id="id-date-picker-1"  value="${requestScope.tbBecomeemployeeexam.get(0).examdate}"
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										...
										value="${requestScope.tbBecomeemployeeexam.get(0).remark}"
