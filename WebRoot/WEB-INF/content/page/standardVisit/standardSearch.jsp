			...
			<div class="main-content-inner">
				<div class="breadcrumbs" id="breadcrumbs">
					...
					<ul class="breadcrumb">
						...
						<li><a href="#">标准化检查成绩管理</a></li>
						<li class="active">标准化成绩查询</li>
					</ul>
				</div>
				<div class="page-content">
					...
					<div class="row">
						<div class="col-xs-12">
							...
							<form action="downData.do?fileName=标准化检查成绩批量导出.xls"
								...
								<table id="dynamic-table"
									...
									<tbody>
										<c:forEach items="${requestScope.TbStandardcheck}"
											var="tbStandardcheck">
											<tr>
												<td class="center"><label class="pos-rel"> <input
														type="checkbox" class="ace" name="cols"
														value="${tbStandardcheck.standardcheckid }" /> <span
														class="lbl"></span> </label></td>
												<td>${tbStandardcheck.organizationNj.orgid}</td>
												<td>${tbStandardcheck.organizationNj.org_Name}</td>
												<td>${fn:split(fn:split(tbStandardcheck.checkdate,' ')[0],'-')[0]}-${fn:split(fn:split(tbStandardcheck.checkdate,' ')[0],'-')[1]}</td>
												<td>${tbStandardcheck.checkscore}</td>
											<td>
													<div class="hidden-sm hidden-xs action-buttons">
														<a class="green" onclick="Modify(this)"
															href="standardVisit.standard.standardSearch.modify.do?id=${tbStandardcheck.standardcheckid}">
															<i class="fa fa-pencil bigger-130">修改</i> </a>
													</div></td>
											</tr>
										</c:forEach>
								</table>
