						...
						<div class="col-xs-12">
							...
							<div class="page-content">
								...
								<div class="page-header">
									<h1>
										业务差错检查成绩管理 <small> <i
											class="ace-icon fa fa-angle-double-right"></i> 成绩单条录入 </small>
									</h1>
								</div>
								<!-- /.page-header -->
										...
										<form class="form-horizontal" role="form" method="post"
											...
											<div class="form-group">
												...
												<div class="col-sm-9">
													<input readonly="" type="text" class="col-xs-10 col-sm-5"
														...
														name="tbOperationcheck.organizationNj.areadesc"
														value="${requestScope.areadesc }" /> <span
											...
											<div class="form-group">
												...
												<div class="col-sm-9">
													<input readonly="" type="text" class="col-xs-10 col-sm-5"
														id="form-input-readonly"
														name="tbOperationcheck.organizationNj.orgid"
														value="<c:forEach items="${requestScope.employeeInfos}"
											...
											<div class="form-group">
												...
												<div class="col-sm-9">
													<input readonly="" type="text" class="col-xs-10 col-sm-5"
														id="form-input-readonly"
														name="tbOperationcheck.organizationNj.org_Name"
														value="<c:forEach items="${requestScope.employeeInfos}"
											...
											<div class="form-group">
												<label class="col-sm-3 control-label no-padding-right"
													for="form-field-1"> 操作姓名： </label>

												<div class="col-sm-9">
													<input readonly="" type="text" class="col-xs-10 col-sm-5"
														id="form-input-readonly"
														name="tbOperationcheck.tbEmployee.employeename"
														value="<c:forEach items="${requestScope.employeeInfos}"
												var="employeeInfo">${employeeInfo.employeename}</c:forEach>" />
													<span class="help-inline col-xs-12 col-sm-7">
														<button class="btn btn-info" type="button"
															onClick="top.window.location='standardVisit.operationMistake.operationMistakeSingle.skipEmployeeSelectSingle.do'">选择员工</button>
													</span>
												</div>
											</div>
											...
											<div class="form-group">
												<label class="col-sm-3 control-label no-padding-right"
													for="form-field-1"> 操作工号： </label>

												<div class="col-sm-9">
													<input readonly="" type="text" class="col-xs-10 col-sm-5"
														id="form-input-readonly"
														name="tbOperationcheck.tbEmployee.employeecode"
														value="<c:forEach items="${requestScope.employeeInfos}"
											...
											<div class="form-group">
												<label class="col-sm-3 control-label no-padding-right"
													for="form-field-1"> 操作身份证号： </label>

												<div class="col-sm-9">
													<input readonly="" type="text" class="col-xs-10 col-sm-5"
														id="form-input-readonly"
														name="tbOperationcheck.tbEmployee.idnumber"
														value="<c:forEach items="${requestScope.employeeInfos}"
												...
												<div class="col-sm-9">
													<div class="input-group col-xs-10 col-sm-5">
														<input class="form-control date-picker "
															...
															name="tbOperationcheck.operationdate"
