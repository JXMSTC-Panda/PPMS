				...
				<div class="page-content">
					...
					<div class="row">
						<div class="col-xs-12">
							...
							<div class="table-header">监控成绩表</div>
							<form action="downData.do?fileName=监控检查成绩批量导出.xls"
									...
									<tbody>
										<c:forEach items="${requestScope.monitorchecks}"
											...
											<tr>
												...
												<td><c:if test="${monitorcheck.checktype=='0001'}">
															表扬
													</c:if>
													<c:if test="${monitorcheck.checktype=='0002'}">
															问题指出
													</c:if>
												</td>
												<td>${monitorcheck.detail}</td>
											</tr>
										</c:forEach>
								</table>
