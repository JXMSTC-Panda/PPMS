					...
					<div class="row">
						<div class="col-xs-12">
							...
							<form class="form-horizontal" role="form"
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input readonly="" type="text" class="col-xs-10 col-sm-5"
											...
											name="monitorcheck.organizationNj.areadesc" /> <span
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input readonly="" type="text" class="col-xs-10 col-sm-5"
											...
											name="monitorcheck.organizationNj.orgid" /> <span
											class="help-inline col-xs-12 col-sm-7"> </span>
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-sm-9">
										<div class="input-group col-xs-10 col-sm-5">
											<select class="col-xs-10 col-sm-5" id="form-field-select-1"
												name="monitorcheck.checktype">
												<option value="0001">表扬</option>
												<option value="0002">问题指出</option>
											</select> <i class="fa fa-calendar bigger-110"></i> </span>
										</div>
									</div>
								</div>
								...
								<div class="form-group">
									<label class="col-sm-3 control-label no-padding-right"
										for="form-input-readonly"> 明细： </label>
									<div class="col-sm-9">
