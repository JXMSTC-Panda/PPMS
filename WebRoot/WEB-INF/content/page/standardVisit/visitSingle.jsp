			...
			<div class="main-content-inner">
				...
				<div class="page-content">
					...
					<div class="page-header">
						<h1>
							暗访检查成绩管理 <small> <i
								class="ace-icon fa fa-angle-double-right"></i> 暗访成绩单条录入： </small>
						</h1>
					</div>
					<div class="row">
						<div class="col-xs-12">
							...
							<form class="form-horizontal" role="form"
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input readonly="" type="text" class="col-xs-10 col-sm-5"
											...
											name="visitcheck.organizationNj.areadesc" /> <span
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input readonly="" type="text" class="col-xs-10 col-sm-5"
											...
											name="visitcheck.organizationNj.orgid" /> <span
											class="help-inline col-xs-12 col-sm-7"> </span>
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input readonly="" type="text" class="col-xs-10 col-sm-5"
											...
											name="visitcheck.organizationNj.org_Name" /> <span
											class="help-inline col-xs-12 col-sm-7">
											<button class="btn btn-info"
												onclick="top.window.location='chooseOrg.do?backUrl=standardVisit.visit.visitSingle.do'"
									...
									<div class="col-sm-9">
										<div class="input-group col-xs-10 col-sm-5">
											<input class="form-control date-picker "
												...
												name="visitcheck.checkdate" /> <span
								...
								<div class="form-group">
									<label class="col-sm-3 control-label no-padding-right"
										for="form-input-readonly"> 第一次成绩： </label>
								...
								<div class="form-group">
									<label class="col-sm-3 control-label no-padding-right"
										for="form-input-readonly"> 一致性成绩： </label>
