					...
					<div class="row">
						<div class="col-xs-12">
							...
							<div class="page-header">
								<h1>
									合作厅上岗证查询 <small> <i
										class="ace-icon fa fa-angle-double-right"></i> 合作厅上岗证查询 </small>
								</h1>
							</div>
							...
							<div class="row">
								<div class="col-xs-12">
									...
									<div>
										<form action="downData.do?fileName=合作厅上岗证批量导出.xls"
												...
												<tbody>
													...
													<c:forEach items="${ requestScope.mgcList}" var="mgc">
														<tr>
															...
															<td>${mgc.examscore }</td>
															<td><c:if test="${mgc.examscore>=60}">
																	<span class="label label-sm label-success">PASS</span>
																</c:if> <c:if test="${mgc.examscore<60}">
																	<span class="label label-sm label-warning">NOT
																		PASS</span>
																</c:if></td>
															<td>
																<div class="hidden-sm hidden-xs action-buttons">
																	...
																	<a class="green"
																		href="userInfo.mountGuardCard.mountGuardCardSearch.modify.do?id=${mgc.examid }">
																		<i class="ace-icon fa fa-pencil bigger-130">修改</i> </a> <a
																		class="red"
																		href="userInfo.mountGuardCard.mountGuardCardSearch.delete.do?id=${mgc.examid }">
