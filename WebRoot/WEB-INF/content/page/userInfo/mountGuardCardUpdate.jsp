									...
									<div class="col-xs-12">
										...
										<form class="form-horizontal" role="form" 
											...
											<div class="form-group">
												...
												<div class="col-sm-9">
													<input readonly="" type="text" class="col-xs-10 col-sm-5"
														id="AreaName" value="0" name="tbMountguardexam.organizationNj.areadesc"/> <span
											...
											<div class="form-group">
												...
												<div class="col-sm-9">
													<input readonly="" type="text" class="col-xs-10 col-sm-5"
														id="AreaName" value="3" name="tbMountguardexam.tbEmployee.employeeid"/> <span
														class="help-inline col-xs-12 col-sm-7"> </span>
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-sm-9">
													<input readonly="" type="text" class="col-xs-10 col-sm-5"
														id="EmployeeId" value="$4" name="tbMountguardexam.tbEmployee.employeecode"/> <span
														class="help-inline col-xs-12 col-sm-7"> </span>
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-sm-9">
													<input readonly="" type="text" class="col-xs-10 col-sm-5"
														id="Id" value="5" name = "tbMountguardexam.tbEmployee.idnumber"/> <span
														class="help-inline col-xs-12 col-sm-7"> </span>
												</div>
											</div>
												...
												<div class="col-sm-9">
													<div class="input-group col-xs-10 col-sm-5">
														<input class="form-control date-picker " id="TrainTime"
															...
															class="input-group-addon" value="6"> <i
											...
											<div class="form-group">
												...
												<div class="col-sm-9">
													<input type="text" id="VaildTime" placeholder="Grade" value="7"
											...
											<div class="form-group">
												...
												<div class="col-sm-9">
													<input type="text" id="ExamGrade" placeholder="Grade" value="$}"
