											...
											<div class="row">
												<div class="col-xs-12">
													<div class="col-xs-6">
														<div class="form-group">
															<label class="col-sm-3 control-label no-padding-right"
																for="form-field-1"> 有无工号: </label>
															<div class="col-sm-9">
																<div class="radio">
																	<label> <input name="form-field-radio"
																		class="ace" type="radio"> <span class="lbl">
																			有工号</span> </label> <label> <input name="form-field-radio"
																		class="ace" type="radio"> <span class="lbl">
																			无工号</span> </label>
																</div>
															</div>
														...
														<div class="form-group">
															<label class="col-sm-3 control-label no-padding-right"
																for="form-field-1"> 是否已分厅: </label>
															<div class="col-sm-9">
																<div class="radio">
																	<label> <input name="form-field-radio1"
																		class="ace" type="radio"> <span class="lbl">
																			已分厅</span> </label> <label> <input name="form-field-radio1"
																		class="ace" type="radio"> <span class="lbl">
																			未分厅</span> </label>
																</div>
															</div>
														...
														<div class="form-group">
															...
															<div class="col-sm-9">
																<select class="form-control" id="form-field-select-1"
																	name="tbEmployee.organizationNj.orgid">
																	<option value=""></option>
