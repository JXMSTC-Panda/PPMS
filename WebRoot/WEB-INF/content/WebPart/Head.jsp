...
<div id="navbar" class="navbar navbar-default">
	...
	<div class="navbar-container" id="navbar-container">
		...
		<button type="button" class="navbar-toggle menu-toggler pull-left"
			...
			<span class="sr-only">Toggle sidebar</span> <span class="fa fa-bar"></span>
			...
			<ul class="nav ace-nav">
						...
						<li class="dropdown-content">
							<ul class="dropdown-menu dropdown-navbar">
								<li><a href="#" class="clearfix"> <img
										src="../Plugin/assets/avatars/avatar.png" class="msg-photo"
								...
								<li><a href="#" class="clearfix"> <img
										src="../Plugin/assets/avatars/avatar3.png" class="msg-photo"
								...
								<li><a href="#" class="clearfix"> <img
										src="../Plugin/assets/avatars/avatar4.png" class="msg-photo"
								...
								<li><a href="#" class="clearfix"> <img
										src="../Plugin/assets/avatars/avatar2.png" class="msg-photo"
								...
								<li><a href="#" class="clearfix"> <img
										src="../Plugin/assets/avatars/avatar5.png" class="msg-photo"
				...
				<li class="light-blue"><a data-toggle="dropdown" href="#"
					class="dropdown-toggle"> <img class="nav-user-photo"
						src="../Plugin/assets/avatars/user.jpg" alt="Jason's Photo" /> <span
